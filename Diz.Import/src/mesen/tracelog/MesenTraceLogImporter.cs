...
public class MesenTraceLogImporter : IDisposable
{
    ...
    public MesenTraceLogImporter(ISnesData? snesData)
    {
        _snesData = snesData;
        ...
        _client = new MesenLiveTraceClient();
    ...
    {
        // Frame markers could be used for synchronization
        // Currently just tracked for statistics
    }
